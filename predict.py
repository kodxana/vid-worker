...
class Predictor(BasePredictor):
    def setup(self):
        ...
        args_dict = {
            ...
            "seed": 65025,
            "neg_prompt": None,
            "ulysses_degree": 8,  # Number of GPUs for Ulysses parallelism
            "ring_degree": 1,     # Number of GPUs for Ring parallelism
        }
        ...
        if args.ulysses_degree > 1 or args.ring_degree > 1:
            ...
            # When using distributed, CPU offload is not supported
    ...
    def predict(
        ...
        output_path = f"/tmp/results/video_{int(time.time())}.mp4"
